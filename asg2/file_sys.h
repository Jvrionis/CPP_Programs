...
class directory: public base_file {
   ...
   public:
      ...
      virtual inode_ptr mkdir (const string& dirname) override;
      virtual inode_ptr mkfile (const string& filename) override;
      virtual inode_ptr get_file (const string& filename);
      virtual void createfile(const string& filename, 
                                          const wordvec& newdata);
      virtual void createdir (const string& filename);
      virtual void addentry (const string& filename,
                                           const inode_ptr& file);
      virtual string printentry ();
      virtual string printentryrec (string content, 
                                           vector <int> *visited);
      virtual int num_files();
      virtual void clear_files();
      virtual bool file_exists(const string& filename);
};
